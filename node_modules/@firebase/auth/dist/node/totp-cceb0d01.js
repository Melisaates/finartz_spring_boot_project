...
function _debugErrorMap() {
    ...
    return _a = {},
        ...
        _a["invalid-phone-number" /* AuthErrorCode.INVALID_phoneNumber */] = 'The format of the phone number provided is incorrect. Please enter the ' +
        ...
        _a["missing-phone-number" /* AuthErrorCode.MISSING_phoneNumber */] = 'To send verification codes, provide a phone number for the recipient.',
...
var AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY = {
    ...
    INVALID_phoneNumber: 'auth/invalid-phone-number',
    ...
    MISSING_phoneNumber: 'auth/missing-phone-number',
...
function signInWithPhoneNumber$1(auth, request) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        return tslib.__generator(this, function (_a) {
            return [2 /*return*/, _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPhoneNumber" /* Endpoint.SIGN_IN_WITH_phoneNumber */, _addTidIfNecessary(auth, request))];
        });
    });
}
function linkWithPhoneNumber$1(auth, request) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPhoneNumber" /* Endpoint.SIGN_IN_WITH_phoneNumber */, _addTidIfNecessary(auth, request))];
                case 1:
                    response = _a.sent();
...
var VERIFY_phoneNumber_FOR_EXISTING_ERROR_MAP_ = (_a = {},
...
function verifyPhoneNumberForExisting(auth, request) {
    return tslib.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib.__generator(this, function (_a) {
            ...
            return [2 /*return*/, _performSignInRequest(auth, "POST" /* HttpMethod.POST */, "/v1/accounts:signInWithPhoneNumber" /* Endpoint.SIGN_IN_WITH_phoneNumber */, _addTidIfNecessary(auth, apiRequest), VERIFY_phoneNumber_FOR_EXISTING_ERROR_MAP_)];
        });
    });
}
